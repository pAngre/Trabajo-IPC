...
public class PrincipalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // LOGO CIRCULAR
        Image imagen = new Image(getClass().getResourceAsStream("/resources/logo2.PNG"));
        circulo.setFill(new ImagePattern(imagen));
        
        //logo = new ImageView(imagen);
        //Image imagen2 = new Image(getClass().getResourceAsStream("/resources/imgSalir.png"));
        //img.setImage(imagen2);
    }    
